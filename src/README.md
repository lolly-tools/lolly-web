...
|---|---|---|---|
| `views/` | 83 files, 91,335 lines | 76 files, 31,402 lines | none |
| `lib/` | 300 files, 80,548 lines | 178 files, 41,184 lines | 7 files, 1,060 lines |
| `bridge/` | 82 files, 37,087 lines | 61 files, 15,524 lines | none |
| `components/` | 39 files, 18,155 lines | 18 files, 7,468 lines | 1 file, 137 lines |
| `collab/` | 18 files, 12,959 lines | 20 files, 13,682 lines | none |
| `pro/` | 20 files, 7,550 lines | 10 files, 1,666 lines | 2 files, 1,194 lines |
| `org/` | 14 files, 5,382 lines | 12 files, 3,642 lines | none |
| `catalog/` | 2 files, 686 lines | 1 file, 86 lines | none |
| `ext/` | 2 files, 136 lines | 1 file, 86 lines | none |
| `styles/` | none | 2 files, 307 lines | 72 files, 34,665 lines |

Plus 39 `.ts`/`.js` files at the top level of `src/`, 11,798 lines all told, of which 14 are tests and 3 are ambient declarations. `main.ts` is 1,425 of that.
<!-- web-src-dirs:end -->
...
| 3,100 | `views/profile.ts` | none |
| 3,006 | `views/tool-inputs.ts` | none |
| 2,866 | `views/gallery.ts` | none |
...
| 2,287 | `views/projects.ts` | none |
| 2,047 | `components/collab-ceremony.ts` | yes |
