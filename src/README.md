...
<!-- web-src-dirs:start -->
Roughly 423,000 lines of TypeScript, tests included, and 40,000 lines of CSS.

| Directory | Source | Tests | CSS |
|---|---|---|---|
| `views/` | 96 files, 101,801 lines | 92 files, 35,129 lines | none |
| `lib/` | 357 files, 93,167 lines | 218 files, 47,609 lines | 7 files, 1,098 lines |
| `bridge/` | 89 files, 39,950 lines | 72 files, 17,438 lines | none |
| `components/` | 44 files, 19,565 lines | 25 files, 8,282 lines | 2 files, 221 lines |
| `collab/` | 18 files, 12,959 lines | 20 files, 13,682 lines | none |
| `pro/` | 20 files, 7,901 lines | 10 files, 1,666 lines | 2 files, 1,210 lines |
...
| `styles/` | none | 3 files, 761 lines | 74 files, 37,561 lines |

Plus 39 `.ts`/`.js` files at the top level of `src/`, 12,917 lines all told, of which 14 are tests and 3 are ambient declarations. `main.ts` is 1,876 of that.
<!-- web-src-dirs:end -->
...
| 5,056 | `views/tool.ts` | partial - the undo/redo model (coalescing, the byte-carrying filter, the cap, the redo chain) is extracted to `tool-history.ts` and covered by `tool-history.test.ts`; the rest of `mountTool` is not. |
