 ...
 * the per-view arrival renderers — all pure Web-Audio math over an injected (ctx, out), no
 * module state. sfx.ts owns mute/volume/dispatch and dynamic-imports this on demand (warmed
