 ...
 * taking the FIRST admissible hue each time. Offsets are measured FROM the
 ...
 *
 * First-admissible, deliberately, not farthest-from-everything. Maximin looks
 ...
 * taken. Two properties fall out, and both are load-bearing:
 *
