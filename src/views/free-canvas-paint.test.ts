 ...
 *
 * The canvas config is the SHIPPED `brands/lolly-start/tools/layout-studio/tool.json` block,
...
const TOOL = join(HERE, '..', '..', '..', '..', 'brands', 'lolly-start', 'tools', 'layout-studio', 'tool.json');
