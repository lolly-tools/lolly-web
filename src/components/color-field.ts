 ...
 * and the form of its solid band is the information. A DIAL does not: Andy asked
...
// hue) is the real form of that axis; the others are a sweep whose two ends meet
